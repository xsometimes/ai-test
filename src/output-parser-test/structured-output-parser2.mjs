/**
 * terminal执行: node ./src/output-parser-test/structured-output-parser2.mjs
 */
...
const parser = StructuredOutputParser.fromZodSchema(scientistSchema);   // Creates a new StructuredOutputParser from a Zod schema.
