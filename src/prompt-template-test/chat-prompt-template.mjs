/**
 * terminal执行: node ./src/prompt-template-test/chat-prompt-template.mjs
 */
...
/**
 * PromptTemplate 产出的就是一个字符串，
 * 实际上我们更多是用 SystemMesage、HumanMessage、AIMessage、ToolMessage 的 messages 数组来调大模型
