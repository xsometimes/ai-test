...
/**
* terminal执行: node ./src/memory-test/memory/retrieval-memory.mjs
* 
实现 Memory 的第三种策略，检索
* 
*/
 ...
 * 
 * 
 * 从向量库中检索相关的记录，根据余弦相似度的原理
 * 再整理成prompt，发给LLM 模型分析，
 * 再将 这一轮对话的 问、答存入到 milvus 的相应的集合
 */
...
${conv.content}`;
    ...
    // 此处的设计可以学一学，检索到相关历史就发给ai，没有就直接发问题
